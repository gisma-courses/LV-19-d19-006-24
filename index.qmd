...
The graded examination is based on a 10-minute scientific presentation on a topic of your choice, using the central techniques taught in the course. The topic should be of personal interest and should be chosen from available data sets or from the student's own classifications, presenting the data in relation to a research question. The presentation, a one-page abstract, and the scripts and sources used are to be posted as a team portfolio (2 people) on github.
